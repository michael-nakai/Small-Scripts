...
#                 FILEPATHS                 #
#############################################
pathToCSVFile <- "/home/michael/xmlTest/Flo_Data.csv"
xmlStorageFolder <- "/home/michael/xmlTest/xml_files"
outputFile <- "/home/michael/xmlTest/Flo_Data_Longform.csv"
...
reallyFinalDF <- finalDF %>% dplyr::select("Longform", everything())
